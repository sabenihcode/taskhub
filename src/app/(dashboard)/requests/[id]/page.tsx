...
// ✅ Remove generateStaticParams - not needed without static export
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                ...
                <InfoItem label="Tanggal Kedatangan" value={formatDate(request.arrivalDate)} />
...
function InfoItem({ label, value, icon, multiline }: InfoItemProps) {
  ...
  return (
    <div className="space-y-1">
      ...
      <p className={`text-sm font-medium ${isEmpty ? "text-slate-400 italic" : "text-slate-900"} ${multiline ? "whitespace-pre-wrap" : ""}`}>
        {displayValue}
      </p>
    </div>
  );
